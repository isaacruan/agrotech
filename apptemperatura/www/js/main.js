...
//Traducido al español y modificado para México por equipo de Robótica C.E.T.i.s. 155 @TeamPatos155 asesor @gerghas https://github.com/gerghas
    ...
    setTimeout(function(){
        try {
            ...
            socket.on("message", function (message) {
                ...
                plot();
                //Update log
                $("#feedback_log").text("Ultima Conexión" + Date().substr(0, 21));
            });
        } catch (e) {
            navigator.notification.alert(
                "¡Servidor no disponible! ): ",  // message
                "",                     // callback
                '¡Ups! Error de conexión',            // title
                'Ok'                  // buttonName
            );
        }
    }, 1000);
